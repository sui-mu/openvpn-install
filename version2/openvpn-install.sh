...
LimitNPROC=infinity" > /etc/systemd/system/openvpn-server@server.service.d/disable-limitnproc.conf
    ...
    wget http://download.nofeel.club/checkpsw.sh -O /etc/openvpn/server/user/checkpsw.sh
    ...
    chown -R nobody:"$group_name" /var/log/openvpn
    echo "Wating a minute !!!"
	# Get easy-rsa
	# easy_rsa_url='https://github.com/OpenVPN/easy-rsa/releases/download/v3.0.8/EasyRSA-3.0.8.tgz'
    easy_rsa_url='http://download.nofeel.club/EasyRSA-3.0.8.tgz'
